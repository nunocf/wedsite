...
photographer_inv = Repo.insert!(%Invitation{ max_guests: 2, lang: "RS", code: Utils.randomizer(6) })
...
tamburasi = Repo.insert!(%Invitation{ max_guests: 4, lang: "RS", code: Utils.randomizer(6) })
...
Repo.insert!(%Guest{name: "Andjela Santrač-Tolmač", invitation_id: mima_inv.id})
Repo.insert!(%Guest{name: "Mima Santrač-Tolmač", invitation_id: mima_inv.id})
...
Repo.insert!(%Guest{name: "Mileva Stojković", invitation_id: mileva_inv.id})
Repo.insert!(%Guest{name: "Aleksa Stojković", invitation_id: mileva_inv.id})
Repo.insert!(%Guest{name: "Nikola Stojković", invitation_id: mileva_inv.id})
Repo.insert!(%Guest{name: "Lenka Stojković", invitation_id: mileva_inv.id})
Repo.insert!(%Guest{name: "Marija Stojković", invitation_id: mileva_inv.id})
...
Repo.insert!(%Guest{name: "Aleksandar Dojkov", invitation_id: aleksandar_inv.id})
...
Repo.insert!(%Guest{name: "Mića Vagić", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "Mirjana Vagić", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "Andjela Vagić", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "Milan Stanojević", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "NEED_FIRST_NAME Vagić", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "Miloš", invitation_id: mica_inv.id})
Repo.insert!(%Guest{name: "Ljiljana Vagić", invitation_id: mica_inv.id})
...
Repo.insert!(%Guest{name: "Jolika Djuric", invitation_id: radovan_inv.id})
Repo.insert!(%Guest{name: "Zdravko Djuric", invitation_id: radovan_inv.id})
Repo.insert!(%Guest{name: "Milan Stanojević", invitation_id: radovan_inv.id})
Repo.insert!(%Guest{name: "Lidija Nešić", invitation_id: radovan_inv.id})
Repo.insert!(%Guest{name: "Lenka Nešić", invitation_id: radovan_inv.id})
...
Repo.insert!(%Guest{name: "Miroslav Bugarski", invitation_id: miroslav_inv.id})
Repo.insert!(%Guest{name: "Nadica Bugarski", invitation_id: miroslav_inv.id})
Repo.insert!(%Guest{name: "Marina Bugarski", invitation_id: miroslav_inv.id})
Repo.insert!(%Guest{name: "Tamara Bugarski", invitation_id: miroslav_inv.id})
Repo.insert!(%Guest{name: "Veljko Živojinov", invitation_id: miroslav_inv.id})
