module Translations exposing (Lang(..), accomodationDesc, accomodationFinal, accomodationTitle, airSerbia, airbnb, airbnbDesc, airplane, apartmani, apartmaniDesc, apartments, apartmentsDesc, belgrade, belgradeAirport, booking, bookingDesc, brussels, budapest, budapestAirport, budapestAirportDistance, bus0, bus1, bus2, bus3, bus4, bus5, bus6, bus7, bus8, bus9, busTitle, car0, car1, carRental0, carRental1, carRental2, carRental3, carRental4, carRentalTitle, carTitle, coordinates, dvoracKastel, dvoracKastelDesc, easyJet, eindhoven, elevenAM, elevenAMDesc0, elevenAMDesc1, elevenAMDesc2, elevenPM, elevenPMDesc0, elevenPMDesc1, em, etc, fourPM, fourPMDesc0, fourPMDesc1, fourPMDesc2, geaTravel, getLnFromCode, hotelVojvodina, hotelVojvodinaDesc, hungary, limba, limbaDesc, londonHeathrow, londonLuton, luqa, luxotel, luxotelDesc, mainAirport0, mainAirport1, mainAirportSecondParagraph0, mainAirportSecondParagraph1, motorbike0, motorbike1, motorbike2, motorbikeTitle, ninePM, ninePMDesc0, ninePMDesc1, novaRent, otherAirports, ourStory0, ourStory1, ourStory10, ourStory11, ourStory12, ourStory13, ourStory14, ourStory15, ourStory16, ourStory17, ourStory18, ourStory19, ourStory2, ourStory20, ourStory21, ourStory22, ourStory23, ourStory24, ourStory25, ourStory26, ourStory27, ourStory28, ourStory29, ourStory3, ourStory4, ourStory5, ourStory6, ourStory7, ourStory8, ourStory9, ourStoryTitle, parisBeauvais, publicTravelFromAirport, romania, romaniaAirportDistance, rsvp0, rsvp1, rsvp2, rsvpTitle, scheduleSubtitle, scheduleTitle, sevenPM, sevenPMDesc0, sevenPMDesc1, showLess, showMore, timetableBelgrade, timetableBelgradeUrl, timetableNoviSad, timetableNoviSadUrl, timisoaraAirport, title, trains0, trains1, trainsTitle, travellingFinal, travellingHeader, travellingSubtitle0, travellingSubtitle1, twelveAM, twelveAMDesc0, twelveAMDesc1, twelveAMDesc2, twoPM, twoPMDesc0, twoPMDesc1, twoPMDesc2, twoPMDesc3, verticallyCenteringInCssIsEasy, villa, villaDesc, walkAndSwim0, walkAndSwim1, walkAndSwimTitle, wizzAir)
...
ourStory4 lang =
    case lang of
        ...
        Rs ->
            "Živela je devojka koja je odbijala da jede povrće."
...
ourStory9 lang =
    case lang of
        ...
        Rs ->
            "Kome ni Rapivab nije mogao izaći na megdan"
...
ourStory11 lang =
    case lang of
        ...
        Rs ->
            "Ustreba joj odveć posebno oružije"
...
ourStory13 lang =
    case lang of
        ...
        Rs ->
            "Magičan kalkulator koji nalazi rešenja čak i u svetu"
...
ourStory15 lang =
    case lang of
        ...
        Rs ->
            "Gde bi ona mogla naći ovakvo čudo?"
...
ourStory17 lang =
    case lang of
        ...
        Rs ->
            "Ono momče, s kojim i tegove beše dizala"
...
ourStory18 lang =
    case lang of
        ...
        Rs ->
            "Nije on bio samo Popajev dalji rođak,"
...
ourStory20 lang =
    case lang of
        ...
        Rs ->
            "Veće i baratao magijom Terminala."
...
ourStory23 lang =
    case lang of
        ...
        Rs ->
            "Devojče pobedi ozloglašeni virus"
...
ourStory26 lang =
    case lang of
        ...
        Rs ->
            "I na kraju rukovaše se u dogovoru"
...
ourStory27 lang =
    case lang of
        ...
        Rs ->
            "Da sve buduće ale pobeđuju zajedno."
...
ourStory28 lang =
    case lang of
        ...
        Rs ->
            "Zato se priključite slavlju ovog neočekivanog umnog spoja."
...
elevenAMDesc2 lang =
    case lang of
        En ->
            "If you are on the Groom’s side this is where you start your day. Marvel at his glorious suit and head over to the Bride’s hoonking all the way!"

        Pt ->
            ""

        Rs ->
            "Ako se priključujete veselju sa mladoženjine strane, ovde ćete započeti svoj dan. Uživajte u pogledu na tu zanosnu bradu i pružite trubi Vaših kola zadovoljstvo da peva iz sveg glasa!"
...
twelveAMDesc2 lang =
    case lang of
        En ->
            "Whether you are on Bride’s side starting your day here or you’ve just arrived with the Groom you’ll be able to witness the rowdy haggling where the Best Man and Grooms’ brother try to outsmart the Bride's family to lower her purchasing price. You are welcome to participate with witty ideas for either side."

        Pt ->
            ""

        Rs ->
            "Bez obzira sa čije ste strane, verujemo da ćete uživati u mladoženjinim pokušajima da se iscenjka za tatinu mezimicu. Dobrodošli ste da učestvujete u nadmetanju na bilo čijoj strani."
...
twoPMDesc0 lang =
    case lang of
        ...
        Pt ->
            "Cerimónia de igreja @ Igreja da Aparição da Virgem Maria"
...
fourPMDesc2 lang =
    case lang of
        En ->
            "Continuing in the “I DO” fashion, our couple becomes joint in the eyes of the state as well. Get the party going while they take some very artistic photos in the gardens and enjoy the traditional appetizers."

        Pt ->
            ""

        Rs ->
            "Nakon državne ceremonije uz nezaboravne stihove Duška Radovića, nadoknadite izgubljenu snagu predjelo i pokrenite proslavu dok se mladenci i sulikaju koji put da bi imali čime da se hvale unucima jednog lepog dana."
...
sevenPMDesc1 lang =
    case lang of
        ...
        Rs ->
            "Priključite se mladencima u prvom plesu i dobro zasluženoj večeri!"
...
ninePMDesc1 lang =
    case lang of
        ...
        Rs ->
            "Slatkiša nikad dosta! Prvo vešto dekorisana mladenačka torta, a zatim i materina pogača koji će Vam mladenci, nadajmo se uspešno, podeliti i top prilikom se i slikati s Vama."
...
travellingSubtitle0 lang =
    case lang of
        ...
        Rs ->
            "Ukoliko ne patite od mučnine izazvane promenama u prostor-vremenu, preporučujemo upotrebu uređaja za teleportaciju koristeći sledeće koordinate:"
...
travellingSubtitle1 lang =
    case lang of
        ...
        Pt ->
            "Se por algum motivo não tiveres acesso a tal aparelho, existem opçōes de transporte mais rudimentares:"

        Rs ->
            "Ako, kojim slučajem, niste u mogućnosti da pribavite takav uređaj, slobodno se poslužite nekim od zastarelih sistema transporta:"
...
otherAirports lang =
    case lang of
        ...
        Pt ->
            "Outros aeroportos de interesse são "
...
publicTravelFromAirport lang =
    case lang of
        En ->
            " In both cases keep in mind that you will need additional transportation service to reach Serbia with fixed price of 15€ from Timisoara and 25€ from Budapest when using "

        Pt ->
            " Em ambos os casos é necessário transporte adicional para chegar à Sérvia, com preço fixo de 15€ de Timisoara e 25€ de Budapeste pela companhia "
...
trains0 lang =
    case lang of
        ...
        Pt ->
            "Para melhor coordenação, dá uma olhadela no horário da Rede Ferroviária da Sérvia para comboios que te levem para Novi Sad ou Beograd Centar."

        Rs ->
            "Raspored vozova možete proveriti na sajtu Železnica Srbije. Direktne linije će Vas dovesti iz Kikinde, Novog Sada i Beograda."
...
trains1 lang =
    case lang of
        En ->
            "Direct connections are available from BEEECCC????? Budapest,Hungary (15€ one way) and from Ljubljana, Slovenia (41€) and Zagreb, Croatia (24€), Thessaloniki, Greece (23€), Skopje, Macedonia (23€) and Sophia, Bulgaria (20€) to Belgrade."

        Pt ->
            "Há comboios directos de Viena, Austria e Budapeste, Hungria para Novi Sad e de Ljubljana, Eslovénia e Zagreb, Croácia para Belgrado."
...
bus0 lang =
    case lang of
        ...
        Pt ->
            "Se não gostas de comboios e preferes andar na estrada, existe a possibilidade de viajar numa camioneta. "

        Rs ->
            "Najsigurniji način provere rasporeda autobusa je ili preko sajta"
...
bus3 lang =
    case lang of
        ...
        Pt ->
            "da estação de camionagem de Novi Sad.  "
...
bus4 lang =
    case lang of
        En ->
            "As there’s no English website choose the date of travel from the drop down menu and specify are you looking for arrivals to Novi Sad (DOLASCI) or departures from Novi Sad (POLASCI) and start typing the name of the city you are interested in. "

        Pt ->
            "Se não fores fluente em sérvio (compreensível!), para usares o site escolhe a data da viagem e seleciona Chegadas (DOLASCI) ou Partidas (POLASCI) para Novi Sad e escolhe a cidade para que pretendes viajar. "
...
bus5 lang =
    case lang of
        ...
        Pt ->
            "Tem em consideração que nem todas as viagens acontecem diáriamente e que o preço está em Dinaras Sérvias (RSD). "
...
bus7 lang =
    case lang of
        En ->
            " of the Belgrade bus stop as well, choose whether you need arrivals or departures, specific date and country and start typing the city’s name in the remaining box. "

        Pt ->
            " da central de Belgrado também, escolhe partidas ou chegadas, escolhe a data de viagem, país destino e começa a escrever o nome da cidade no campo restante. "
...
bus8 lang =
    case lang of
        ...
        Pt ->
            "Os nomes dos países estão em sérvio, portanto se tiveres dúvidas e precisares de ajuda/tradutores avisa-nos, estamos aqui para ajudar. "
...
bus9 lang =
    case lang of
        En ->
            "Unfortunately this site won’t provide you with the ticket price (Serbia is a lovely country, and people still really like to give everyone a call), so in case you find something you think will work for you, let us know and we’ll get the price information. "

        Pt ->
            "Infelizmente esta pagina não tem informação de preços dos bilhetes. Na amável Sérvia, as pessoas ainda preferem telefonar para saber informaçōes, e podemos fazer isso por ti, claro!"
...
car0 lang =
    case lang of
        ...
        Pt ->
            "Se decidires conduzir, o melhor é mesmo tirar uns dias e parar em sítios de interesse, a viagem é longa."

        Rs ->
            "Ako se odlučite da povedete svog mezimca u vožnju, sigurni smo da će biti vrlo srećan jer će osim aktivnog dana dobiti i veselu cvetnu dekoraciju! Zrenjanin se nalazi na 50km of Novog Sada i 80km od Beograda."
...
car1 lang =
    case lang of
        ...
        Pt ->
            "Se viajares do Porto são 3000km e demorará cerca de 3-4 dias longos a conduzir."
...
motorbike0 lang =
    case lang of
        ...
        Pt ->
            "É sempre uma boa idea vires na amiga de duas rodas! "

        Rs ->
            "Ako ste avanturističkog duha ovo može biti odlična opcija! Vreme u septembru je generalno toplo i suvo tako da će i sam put biti prijatan. Po dolasku Vas očekuju brufen, voda i šećer u neograničenim količinama. Naravno i sva slava ovakovog poduhvata, jer i mi volimo dvotočkaše svih oblika!🏍🏍🏍"
...
motorbike1 lang =
    case lang of
        ...
        Pt ->
            "O tempo em setembro costuma ser bom, e é a desculpa perfeita para uma aventura para contar aos netos! "
...
motorbike2 lang =
    case lang of
        En ->
            "Paramedics and sugary water will be available upon reaching the destination. And all the glory of course, we love bikes! 🏍 Don't forget to show us the pictures!"

        Pt ->
            "Garantimos médicos, água com açúcar e Rakia para ajudar com a recuperação motoqueira, juntamente com um incrível respeito. Não te esqueças de mostrar as fotos. Nós adoramos motas! 🏍"
...
walkAndSwim0 lang =
    case lang of
        ...
        Pt ->
            "Tu é que és maluco, chefe! "

        Rs ->
            "Hvale vredan podvig! Nemamo šta da dodamo, osim da na vreme potvrdite dolazak pa put pod noge, da ne zakasnite!"
...
walkAndSwim1 lang =
    case lang of
        ...
        Pt ->
            "Bem, mas se quiseres mesmo, confirma o RSVP e toca a despachar, senão chegas atrasado!"
...
carRentalTitle lang =
    case lang of
        En ->
            "Can't live without your car?"

        Pt ->
            "Não vives sem o teu carro?"
...
carRental1 lang =
    case lang of
        ...
        Pt ->
            "Se chegares a Belgrado nós recomendamos "
...
carRental2 lang =
    case lang of
        ...
        Pt ->
            "O site está em sérvio, mas toda a equipa fala inglês. Os preços são bons e eles entregam te o carro a qualquer altura do dia. "
...
carRental3 lang =
    case lang of
        ...
        Pt ->
            "Além disso, podes passar fronteiras (tanto dentro e fora da UE) sem limites de quilometragem. "
...
carRental4 lang =
    case lang of
        ...
        Pt ->
            "Escolhe o carro que queres e manda-lhes um mail/WhatsApp com informaçaão sobre a tua viagem e eles ajudam te no processo todo."
...
travellingFinal lang =
    case lang of
        ...
        Pt ->
            "Qualquer que seja a tua preferência de transporte, contacta-nos que temos todo o gosto em ajudar-te a organizar tudo."

        Rs ->
            "Ukoliko su Vam potrebne bilo kakve informacije ili pomoć vezana za transport stojimo Vam na raspolaganju."
...
dvoracKastelDesc lang =
    case lang of
        En ->
            "This is our venue! They offer 38 rooms and 7 suites ranging from 40€ to 90€ a night. If you decide to book, mention you are in out wedding party and you will receive complimentary 15% discount for 2 nights. "

        Pt ->
            "O casório é aqui! Existem 38 quartos e 7 suites de 40€ até 90€ por noite (preço por quarto). Se quiseres reservar, diz-lhes que vais estar lá na nossa festa e tens 15% de desconto por 2 noites. "

        Rs ->
            "Mesto svadbene proslave! Dvorac nudi 38 soba i 7 apartmana po ceni od 40€ do 90€ na noć. Ako se odlučite za rezervaciju, pomenite da ste gosti na našoj svadbi kako bi dobili dodatnih 15% popusta za dve noći. "
...
rsvp0 lang =
    case lang of
        ...
        Pt ->
            "Preenche o RSVP até dia 1 de Julho, por favor."
...
rsvp1 lang =
    case lang of
        ...
        Pt ->
            "Se tiveres alergias ou dietas alternativas, informa-nos na secção das Notas. "

        Rs ->
            "Prilikom potvrde dolaska obavestite nas o mogućim alregijama, intolerancijama ili posebnim dijetama o kojima bi trebali da vodimo računa, kao i da li su Vam potrebne usluge transporta na dan venčanja (skup svatova - crkva - restoran)."
...
rsvp2 lang =
    case lang of
        ...
        Pt ->
            "Avisa-nos também se precisas de transporte, para tentarmos organizar forma de te ir buscar ao aeroporto/estação, ou dar-te boleia para qualquer um dos lugares da festa (Casa do noivo - casa da noiva - Castelo)"
