        ...
        [ div [ class "accomodationGrid", attribute "height" "100%" ]
            [ a [ href "https://www.booking.com", target "_blank", class "bookingSquare pointerCursor movable roundCorners boxShadow svgLinkA" ]
                [ span [ class "svg-container centerSvg svgSpan" ]
                    [ object [ class "pointerCursor svg-content svg55Pct centerSvg svgObject", type_ "image/svg+xml", attribute "data" "svg/booking.svg" ]
            ...
            , a [ href "https://www.airbnb.com", target "_blank", class "airbnb pointerCursor movable roundCorners boxShadow svgLinkA" ]
                [ span [ class "svg-container centerSvg svgSpan" ]
                    [ object [ class "pointerCursor svg-content centerSvg svgObject", type_ "image/svg+xml", attribute "data" "svg/airbnb.svg" ]
                        [ text "Your browser does not support SVGs" ]
                    ]
                ]
